...
section: "Guides"
weight: 60
source: "file:///home/janpf/Projects/gomlx/gomlx/docs/error_handling.md"
---
...
`graph.Graph`, `model.Scope` and `tensors.Tensor` objects report errors using "exceptions" (`panic` with errors 
