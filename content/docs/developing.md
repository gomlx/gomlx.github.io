---
title: "Developing In GoMLX"
section: "Guides"
weight: 40
---

This file holds considerations when contributing to GoMLX development.

It's quite empty, in the sense that there are not many special requirements, other than
what is already covered for normal GoMLX usage and standard Go.
...
Instead, we do it manually using the `internal/cmd/run_coverage.sh` simple script. 
